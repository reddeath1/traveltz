			...
			<div class="col-lg-9">
				...
				<div class="seat-keys mt-2 mb-2">
					<div class="container">
						<div class="row">
							<div class="col-md">
								<button class="btn-key-booked"></button> Booked
							</div>
							<div class="col-md">
								<button class="btn-key-available"></button> Available
							</div>
							<div class="col-md">
								<button class="btn-key-unavailable"></button> Unavailable
							</div>
							<div class="col-md">
								<button class="btn-key-selected"></button> Selected
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-3 summary">
				<div class="card">
					<div class="card-header">
						summary
						<span class="float-right" data-toggle="collapse" data-target="#collapsible-summary"><ion-icon name="menu"></ion-icon></span>
					</div>
					<div class="card-body collapse" id="collapsible-summary">
						...
						<p><strong>Seat(s) selected: </strong>2</p>
					...
					<ul class="list-group list-group-flush">
						<li class="list-group-item"><strong>SUBTOTAL:</strong>
							<ul class="subtotal-0">
								<li><strong>Economy (2):</strong> 50000Tzs</li>
								<li><strong>VIP (1):</strong> 35000Tzs</li>
							</ul>
						</li>
						<li class="list-group-item"><strong>TOTAL</strong>: <span class="float-right">85000Tzs</span></li>
					</ul>
				</div>
				<a href="<?php echo $url;?>/personal details/" class="btn btn-banner btn-block mt-2">NEXT</a>
			</div>
		</div>
	</div>
</div>
